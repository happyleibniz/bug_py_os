...
def chrome_web():
    ...
    class MainWindow(QMainWindow):
        ...
        def __init__(self, *args, **kwargs):
            ...
            # making browser goes back
            back_btn.triggered.connect(self.browser.back)

            # adding this action to the toolbar
            ...
            # adding action when a return key is pressed
        ...
        # method called by the line edit when a return key is pressed
...
def user_defalt():
    global running, currentdir, video_excample
    get = False
    running = True
    ggs = False
    viruss = False
    ...
    bruhhhhh = False
    # Define a flag to check if paint is open
    paint_open = False

    # Define the paint canvas dimensions and color
    canvas_rect = pygame.Rect((200, 156), (600, 250))  # Adjust position (x, y) as needed
    canvas_color = (255, 255, 255)
    draw_color = (0, 0, 0)
    paint_button_accesable = False

    brush_size = 5  # Adjust brush size as needed
    # Add to the main loop in start_computer function
    ...
    while running:
        ...
        # Define the paint button
        try:
            paint_button_img = pygame.image.load("./images/microsoft_paint.png")
            paint_button = Button(image=paint_button_img, pos=(30, 390), text_input="", font=get_font(1), base_color="white", hovering_color="green")
            paint_button.changeColor(OPTIONS_MOUSE_POS)
            paint_button.update(screen)
            paint_button_accesable = True
        except FileNotFoundError:
            print("<!>WARNING:no image images/microsoft_paint.png")
            paint_button_accesable = "No_File"
        ...
        # OPTIONS_BACK.update(screen)
                # Draw the canvas if paint is open
        if paint_open:
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_q:
                    if bruhhhhh == True:
                        ...
                        pygame.display.update()
            if event.type == pygame.MOUSEBUTTONDOWN:
                if paint_button_accesable is True:
                    if paint_button.checkForInput(OPTIONS_MOUSE_POS):
                        paint_open = not paint_open  # Toggle paint open state
                ...
                if movies.checkForInput(OPTIONS_MOUSE_POS):
                    ...
                    if bruhhhhh == True:
                        ...
                        video_excample = Video("video.mp4")  # you can use .mkv
                        video_excample.play()
                        # bruhhhhh=False
                    elif bruhhhhh == False:
                        pass
                ...
                if virus.checkForInput(OPTIONS_MOUSE_POS):
                    import os
                    os.system("software/code/This-PC.exe")
                    print("Open PC")
                ...
                if Calculatorbt.checkForInput(OPTIONS_MOUSE_POS):
                    ...
                    print("cala")
                        # Draw on the canvas if the mouse is pressed
            if pygame.mouse.get_pressed()[0]:
                ...
                if paint_open:
                    if canvas_rect.collidepoint(mouse_pos):
                        ...
                        pygame.display.update()
                        #screen.set_at(mouse_pos, draw_color)
